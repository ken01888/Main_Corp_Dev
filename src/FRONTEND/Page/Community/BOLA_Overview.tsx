                            ...
                            <Col xs={{ span: 22, order: 2 }} md={{ span: 8, order: 1 }}>
                                ...
                                <div >
                                    ...
                                    <Alert
                                        description=
                                        {
                                            `Here, you have the opportunity to experience firsthand the power of customized insights tailored to your unique needs.  This information forms the foundation for our precision nutrition recommendations, ensuring that your journey with BoLA is not only insightful but also specifically designed to support your well-being. We believe in the transformative impact of informed choices, and the BoLA Demo Area is your gateway to a healthier and more personalized approach to nutrition. `
                                        }
                                        type="warning"
                                        className='heroText'
                                    />
                                ...
                                <div className='heroText'>
                                    ...
                                    >
                                        <span>
                                            ...
                                            <h3>BoLa Playground</h3>
                                        </span>
                                        <Alert
                                            description="
        The following example showcases how to use BoLa by comparing the nutrient content of a McDonald's Big Breakfast to an individual's nutrient requirements based on their gender and life stage. To get started, please enter your age and select the appropriate gender. Once you've entered the inforamtion and pressed submit two charts will appear in the blue and biege boxes.
"
                                            type="warning"
                                            className='heroText'
                                        />
                                        ...
                                        >
                                            ...
                                            >
                                                <Select
                                                    suffixIcon={<User size={20} weight="bold" color="#849FD1" />}
                                                    placeholder='Age:'
                                                    style={{
                                                    ...
                                                    variant="borderless"
                                                >
                                                    <Select.Option value="2-3 years old">2-3</Select.Option>
                                                    <Select.Option value="4-8 years old">4-8</Select.Option>
                                                    <Select.Option value="9-13 years old">9-13</Select.Option>
                                                    <Select.Option value="14-18 years old">14-18</Select.Option>
                                                    <Select.Option value="19-30 years old">19-30</Select.Option>
                                                    <Select.Option value="31-50 years old">31-50</Select.Option>
                                                    <Select.Option value="over 50 years old">Over 50</Select.Option>
                            ...
                            <Col xs={{ span: 22, order: 2 }} md={{ span: 8, order: 1 }} className='alignCol_1'>
                                ...
                                <Space wrap >
                                    ...
                                    <ResponsiveContainer width="100%" height={300} initialDimension={{ width: 300, height: 300 }}>
                                        <LineChart width={500} height={300} data={reply}>
                                            <CartesianGrid strokeDasharray="3 3" fill={background ? "white" : "#849FD1"} />
                                            <XAxis includeHidden dataKey="Name" offset={0} padding={{ left: 10, right: 10 }}>
                                                <Label offset={0} position="bottom" />
                                            </XAxis>
                                            <YAxis label={{ value: 'Amounts', angle: -90, position: 'insideBottomLeft' }} padding={{ top: 10, bottom: 10 }} minTickGap={10} />

                                            <Tooltip wrapperStyle={{ border: '1px solid #4D4D4F' }} cursor={{ stroke: '#4D4D4F', strokeWidth: 1 }} />
                                            <Text scaleToFit />

                                            <Line type="monotone" dataKey="Distinct" name='OIL' stroke="#849FD1" activeDot={{ r: 8 }} strokeWidth={1} >

                                            </Line>

                                            <Line type="monotone" name="McDonald's Big Breakfast" dataKey="McDonaldsBigBreakfast" stroke="#4D4D4F" activeDot={{ r: 8 }}>

                                            </Line>
                                            <Brush dataKey="McDonaldsBigBreakfast" height={50} stroke="#E8DAC2" />
                                    ...
                                    <ResponsiveContainer width="100%" height={300} initialDimension={{ width: 300, height: 300 }} >
                                        ...
                                        >
                                            <CartesianGrid strokeDasharray="3 3" fill={background ? "white" : "#E8DAC2"} />
                                            <XAxis dataKey="Name" name='' padding={{ left: 10, right: 10 }} onClick={(e) => { console.log(e) }} includeHidden>
                                            </XAxis>
                                            <YAxis padding={{ top: 10, bottom: 10 }} minTickGap={10} />
                                            <Tooltip wrapperStyle={{ border: '1px solid #4D4D4F' }} cursor={{ stroke: '#4D4D4F', strokeWidth: 1 }} />
                                            <Text scaleToFit />
                                            <Brush dataKey="McDonaldsBigBreakfast" height={50} stroke="#E8DAC2" />
                                            <Bar dataKey="Distinct" name='OIL' barSize={20} fill="#849FD1" activeBar={{ stroke: '#4D4D4F', strokeWidth: 1 }} />
                                            <Scatter dataKey="McDonaldsBigBreakfast" fill="#4D4D4F" />
                                        </ComposedChart>
                                    </ResponsiveContainer>
