...
import { Col, Divider, Layout, Row, Form, Input, ConfigProvider, Button, } from 'antd'
...
const Support: React.FC = () => {
    ...
    const onFinish = async (values: any) => {
        ...
        let newData = await fetch('http://localhost:8000/support_message', {
            method: 'POST',
            headers: {
            ...
            <Layout className='homeScreenDesktop'>
                ...
                transition={{ duration: .5 }}>
                            ...
                            {showForm ?
                               ...
                               <Divider className='dividerHeader'></Divider><ConfigProvider
                                    theme={{
                                        token: {
                                            fontFamily: 'Jost',
