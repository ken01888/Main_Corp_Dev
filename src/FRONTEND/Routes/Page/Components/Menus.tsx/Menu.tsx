                    ...
                    <div className='menuItemsDiv'>
                        {/* <Link to='/login' onClick={showDrawer} className='menuMiddleItems'>
                         ...
                         <ConfigProvider
                                        ...
                                        >
                                            <Button htmlType="submit"><NavLink to='/login'>Log In</NavLink></Button>
                                        ...
                                        <ConfigProvider
                                            theme={{
                                                token: {
                                                    fontFamily: 'Jost',
                                                    colorTextTertiary: '#fafafa',
                                                    colorPrimaryHover: '#ffffff',
                                                    colorBgContainer: '#000000',
                                                    colorText:'#fafafa',
                                                    colorPrimaryActive:'#B4CBD4'

                                                },
                                            }}
                                        >
                                            <Button htmlType="submit"><NavLink to='/signup'>Sign Up</NavLink></Button>
